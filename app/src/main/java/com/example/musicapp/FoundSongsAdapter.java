...
public class FoundSongsAdapter extends RecyclerView.Adapter<FoundSongsAdapter.FoundSongViewHolder> {

    private ArrayList<Song> foundSongs;
    private ArrayList<Song> favouriteSongs;
    final private ListItemClickListener mOnClickListener;

    public FoundSongsAdapter(ArrayList<Song> songs, ArrayList<Song> favouriteSongs, ListItemClickListener mOnClickListener) {
    ...
    @Override
    public FoundSongViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(FoundSongViewHolder holder, int position) {
    ...
    public class FoundSongViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ImageView songImage, favouriteImage;
        TextView songName, artistName;

        FoundSongViewHolder(View itemView) {
            super(itemView);
            ...
            favouriteImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Song song = foundSongs.get(getAdapterPosition());
                    if(song.isFavourite()){
